...
public class EmailMain {
	...
	public static void main(String[] args) {
		...
		emails[5] = new Email("Buch ausleihen", "Hey Hannes,\nTim sagte mir du hast die ganze Harry Potter Reihe an Büchern. Ich habe gerade voll Langeweile und würde mir gerne mal etwas Leselektüre ausleihen. Ich bring dir als Danke mal ein 6er Bier vorbei :) Gr��e\nAnna");
		...
		emails[8] = new Email("Game Jam", "Moinsen,\nhab gehört der FSR organisiert einen Game Jam. Weißt du wann der ist? Hütte da ja mal echt Bock drauf, wie schauts bei dir aus?\n\nViele Grüße\nBasti");
		...
		emails[20] = new Email("Bla", "23:59:21");
		emails[21] = new Email("Bla", "00:23:81");
		emails[22] = new Email("Bla", "00:29:51");
		emails[23] = new Email("Bla", "20:53:09");
		emails[24] = new Email("Bla", "20:53:09 - Pizza bestellt!");
		
		// A...d
//		String regex = "(Haus)|(Häuser)";
//		String regex = "\\s[Aa][a-z]*[d]\\s";
//		String regex = "\\s[Aa]\\w*[d]*[d]\\s";
//		String regex = "\\s[S][tefan]\\s";
//		String regex = "(^|\\s)[sS][a-z]*[e](\\s|[.,?!:;]|$)";
